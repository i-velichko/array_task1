...
public class IntStreamArrayCalculateServiceImplTest {
    private final static int[] ARRAY_FOR_CALCULATE = {3, 5, 12, 44, 2, 35, 66, 1, 6, 87};
    private final IntStreamArrayCalculateServiceImpl arrayCalculateService = new IntStreamArrayCalculateServiceImpl();
